...
import { Camera, ChevronRight, History, Sparkles, Upload, Zap, Activity, Shield, LogOut } from "lucide-react";
        ...
        <div className="flex items-center gap-2">
          ...
          {user && (
            <button
              ...
              onClick={() => logoutUser()}
              title="Sign Out"
              className="flex size-11 items-center justify-center rounded-2xl transition-all duration-200 hover:scale-105 active:scale-95 cursor-pointer"
              style={{
