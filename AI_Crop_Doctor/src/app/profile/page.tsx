...
import { ChevronRight, History, Languages, Leaf, MapPin, Volume2, Cpu } from "lucide-react";
  ...
  return (
    <div className="surface flex items-center gap-3 p-4">
      ...
      <button
        ...
        className={cn(
          "h-7 w-12 shrink-0 rounded-full transition-colors",
      ...
      <div className="space-y-5 px-5 py-5">
            ...
            <div className="mt-4 rounded-2xl bg-accent-soft p-4 border border-accent/20 flex flex-col gap-2">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5 leading-relaxed">
                  Sync and persist your AI leaf diagnosis history, crop calendar, and custom
                  reminders to Nadia Cloud.
                </p>
              </div>
              <Link
                href="/login"
        ...
        <section className="space-y-3">
          ...
          <Toggle
            ...
            hint="Read out diagnosis results and reminders (fully functional via Web Speech API)"
        ...
        <section className="space-y-3">
          <Link href="/history" className="surface flex items-center gap-3 p-4">
          ...
          <Link href="/crops" className="surface flex items-center gap-3 p-4">
            <span className="flex size-10 items-center justify-center rounded-xl bg-secondary">
          ...
          <Link href="/architecture" className="surface flex items-center gap-3 p-4">
            <span className="flex size-10 items-center justify-center rounded-xl bg-secondary">
              <Cpu className="size-5" aria-hidden />
            </span>
            <span className="flex-1 text-sm font-semibold">System Architecture & Stack</span>
            <ChevronRight className="size-5 text-muted-foreground" aria-hidden />
          </Link>
        </section>
        ...
        <NotificationCard
          ...
          body="Voice guidance and dictation are fully active on Chrome/Safari using local browser TTS/STT APIs. Additional local language dictionaries will be switched on with the backend update."
          tone="accent"
        />
