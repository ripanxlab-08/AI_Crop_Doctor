...
export default function SplashOnboarding() {
    ...
    return (
      <main className="field-hero flex min-h-screen flex-col items-center justify-center px-8 text-center">
        <div className="relative flex size-44 items-center justify-center">
          <span
            className="absolute inset-0 animate-ring rounded-full bg-primary-foreground/25"
            aria-hidden
          />
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-screen-sm flex-col px-6 pb-10 pt-6">
      ...
      <div
        key={slide}
        className="animate-rise flex flex-1 flex-col items-center justify-center text-center"
      >
        <div className="relative flex size-52 items-center justify-center rounded-[2.5rem] bg-primary-soft shadow-lift">
          <img
            ...
            height={1024}
            loading="lazy"
            className="size-32 animate-leaf"
          />
