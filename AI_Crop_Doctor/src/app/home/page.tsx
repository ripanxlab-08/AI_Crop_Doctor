...
export default function HomeScreen() {
  ...
  return (
    <AppShell>
      ...
      {/* Recommended Architecture & Stack Information */}
      <section className="px-5 pt-4">
        <div className="surface-lift animate-rise relative overflow-hidden rounded-3xl p-5 bg-gradient-to-br from-primary-soft to-card border border-primary/20">
          <span className="absolute -right-6 -bottom-6 text-7xl opacity-10 select-none pointer-events-none">
            ⚙️
          </span>
          <div className="relative">
            <span className="inline-flex items-center gap-1 rounded-full bg-primary/20 px-2.5 py-0.5 text-[10px] font-bold text-primary">
              SYSTEM CONTEXT
            </span>
            <h3 className="mt-2 font-display text-base font-bold text-foreground">
              Architecture & Stack
            ...
            <div className="mt-4">
              <Link
                href="/architecture"
                className="inline-flex min-h-10 items-center justify-center rounded-xl bg-primary px-4 text-xs font-bold text-primary-foreground shadow-[0_3px_0_oklch(0.35_0.1_152)] active:shadow-none active:translate-y-[3px] transition-all"
              >
      ...
      <section className="px-5 pt-7">
        <SectionTitle
          action={
            <Link href="/crops" className="text-xs font-semibold text-primary">
              All crops
            </Link>
          }
        >
