...
import { Mail, Lock, User as UserIcon, ArrowRight, Check, Loader2, Eye, EyeOff, ChevronLeft } from "lucide-react";
  ...
  head: () => ({
    meta: [
      { title: "AI Crop Doctor" },
      {
        name: "description",
        content:
          "Sign in to back up your crop diagnosis history, plan crop activities, and connect with expert coaching.",
      },
    ],
  }),
...
function LoginScreen() {
  ...
  const handleSocialLogin = async (platform: "Google" | "Apple") => {
    ...
    try {
      ...
      setIsLoading(false);
      setValidationError(err.message || "OAuth login failed");
    }
  };
        ...
        {isSuccess ? (
          ...
          <div
            ...
            style={{
              ...
              transition: tilt.x === 0 && tilt.y === 0 ? "transform 0.5s cubic-bezier(0.16, 1, 0.3, 1)" : "transform 0.05s ease-out",
            }}
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className="relative py-2.5 px-4 rounded-xl border border-border bg-card text-foreground text-xs font-semibold shadow-[0_3px_0_oklch(0.9_0.015_110)] active:shadow-[0_1px_0_oklch(0.9_0.015_110)] active:translate-y-[2px] transition-all hover:bg-muted flex items-center justify-center gap-2 cursor-pointer"
              >
                <svg viewBox="0 0 24 24" className="size-4 fill-current text-foreground shrink-0" aria-hidden="true">
